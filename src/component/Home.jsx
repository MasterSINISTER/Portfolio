...
export default function Home() {
  ...
  return (
	...
	<h1>
		...
		<div id="title"><TypeIt><span>Rishabh Gupta</span></TypeIt></div>
	</h1>
...
<section id="about" class="dark">
	...
	<div>
		<h3>Hey there, I'm <TypeIt><span class="blue">Rishabh Gupta</span></TypeIt></h3>
		<div class="row">
			<div>
				<p>In short: I'm a Tech Addict, Web Dev, Fitness Freak, College Student.</p>
				<p>I am a college freshman that taught myself how to code in my spare time as a highschooler. I love Coding, Development, Learning New Things, Travelling and anything tech-related. I love making Websites! I specialize in Front-End development and work hard to pursue excellence in all my projects and are accessible. I also do the "techy" jobs for my friends, like plugging in or restarting a computer.</p>
				
			</div>
			<div>
				<ul>
					<li><span>Name:</span> Rishabh Gupta</li>
					<li><span>Contact Me: </span>hellolucifer007@gmail.com</li>
...
<section id="skills">
	...
	<div class="row">
		<div class="card">
			<div class="card-title"><i class="fa-solid fa-pen-ruler"></i>
				<h3>HTML5</h3>
			</div>
			<p>I work hard to make my websites stylish, intuitive and easy to use. I also love researching the psychology behind designs, such as color theory, button placement, etc.</p>
		</div>
		<div class="card">
			<div class="card-title"><i class="fa-solid fa-palette"></i>
				<h3>CSS3</h3>
			</div>
			<p>I Design and Animate my Website using CSS and sometimes  Tailwind </p>
		</div>
		<div class="card">
			<div class="card-title"><i class="fa-solid fa-desktop"></i>
				<h3>BOOTSTRAP</h3>
			</div>
			<p>Everything I do is on the web includes a little bit of Bootstrap Elements.</p>
		</div>
		<div class="card">
			<div class="card-title"><i class="fa-solid fa-code"></i>
				<h3>Multi Lingual</h3>
			</div>
			<p>I am compitant in HTML5, CSS3, Javascript, jQuery, SVG, HTML Canvas, and Firebase.</p>
		</div>
	</div>
</section>

<section id="socials" class="dark">
	<div class="section-title">
		<h2>SOCIALS</h2>
		<p>Let's Connect</p>
